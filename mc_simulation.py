#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Factory Farming / Protein Demand Floor
======================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Factory Farming (Protein Demand Floor).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "factory_farming",
    "domain_name": "Factory Farming",
    "theorem": "Protein Demand Floor",
    "classification": "Class 1 \u2014 Impossibility",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 67.0,
    "channels": {
        "C1_ghg_carbon": {
            "dist": "lognormal",
            "low": 500,
            ...
            "high": 1200,
            "weight": 0.25,
            "description": "GHG emissions, carbon opportunity cost, land use"
        },
        "C2_water_pollution": {
            "dist": "lognormal",
            "low": 250,
            ...
            "high": 650,
            "weight": 0.18,
            "description": "Water pollution, nutrient runoff, dead zones"
        },
        "C3_pandemic_amr": {
            "dist": "lognormal",
            "low": 300,
            ...
            "high": 900,
            "weight": 0.2,
            "description": "Pandemic risk, antimicrobial resistance"
        },
        "C4_air_pollution": {
            "dist": "lognormal",
            "low": 200,
            ...
            "high": 550,
            "weight": 0.12,
            "description": "Air pollution mortality from ammonia, particulates"
        },
        "C5_animal_welfare": {
            "dist": "lognormal",
            "low": 212,
            ...
            "high": 850,
            "weight": 0.15,
            "description": "Animal welfare destruction (AQALY shadow pricing)"
        },
        "C6_governance": {
            "dist": "lognormal",
            "low": 38,
            ...
            "high": 85,
            "weight": 0.1,
            "description": "Subsidy distortion, regulatory capture, ag-gag laws"
        }
    },
